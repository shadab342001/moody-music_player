...
const songs =[
    ...
    {
        id:2,
        songName: `dil mera dekho na meri hesiyat pucho<br>
    ...
    {
        id:4,
        songName: `Tera Naam Dhokha Rakh Doon <br>
        <div class="subtitle">Arjit Singh</div>`,
    ...
    {
        id:6,
        songName: `Jag Se Hara nahi main  <br>
        <div class="subtitle">Arjit Singh</div>`,
    ...
    {
        id:10,
        songName: `Jo tu mera hamdard hai.<br>
        <div class="subtitle">Arjit Singh</div>`,
    ...
    {
        id:13,
        songName: `Ae watan watan mere aabaad rahe tu <br>
        <div class="subtitle">Arjit Singh</div>`,
...
Array.from(document.getElementsByClassName('playListplay')).forEach((e) =>{
    e.addEventListener('click',(el)=>{
        ...
        masterPlay.classList.remove('bi-play-fill');
        masterPlay.classList.add('bi-pause-fill');
        download.href = `audio/arjit/${index}.mp3`;
